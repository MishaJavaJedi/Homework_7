...
fun main() {
    ...
    val comment = Comment(id = -2147483648,fromId = 212,date = 442315,text = "Comment text",replyToUser = 39,replyToComment = 53,photoAtt)
    ...
    val original = Post(
        ...
        replyPostId = 1,
        friendsOnly = true,
        comment = Comment(1,fromId = 2,date = 2342315,text = "Comment text",replyToUser = 3,replyToComment = 4,photoAtt),
